...
public class Pojo {
	...
	/*
	 * public String getBusiness_name() { return business_name; } public void
	 * setBusiness_name(String business_name) { this.business_name = business_name;
	 * }
	 */
	...
	/*
	 * public String getName_customer() { return name_customer; } public void
	 * setName_customer(String name_customer) { this.name_customer = name_customer;
	 * }
	 */
	...
	public void setBuisness_year(String buisness_year) {
	    ...
	    String year = null;
	    try {
	      String newDateStr = sdf.format(sdf.parse(buisness_year));
	...
	public String toString() {
		return "Pojo [sl_no=" + sl_no + ", business_code=" + business_code + ", cust_number=" + cust_number
